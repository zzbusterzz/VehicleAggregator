    ...
    <body id="main_body"  style="height:1500px">
        ...
        <div class="container" style="margin-top:50px">
            ...
            <div class="table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px" id="dbcontainer">
                ...
                <input id="fname" type="text" name="fname" value = {{ $data[0]->lastname }} class="form-control"/>
                <input id="fname" type="text" name="fname" value = {{ $data[0]->phone }} class="form-control"/>
                <input id="fname" type="text" name="fname" value = {{ $data[0]->email }} class="form-control"/>
